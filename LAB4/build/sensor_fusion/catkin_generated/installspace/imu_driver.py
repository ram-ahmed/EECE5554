...
import rospy
from sensor_fusion.msg import Vectornav
from sensor_fusion.srv import convert_to_quaternion_datatype,convert_to_quaternion_datatypeResponse
...
def imudata_sender():
    ...
    serial_port = rospy.get_param('/imu_port', '/dev/ttyUSB0')
