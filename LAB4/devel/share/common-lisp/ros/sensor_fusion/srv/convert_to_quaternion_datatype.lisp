...
(cl:defmethod cl:initialize-instance :after ((m <convert_to_quaternion_datatype-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'convert_to_quaternion_datatype-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_fusion-srv:<convert_to_quaternion_datatype-request> is deprecated: use sensor_fusion-srv:convert_to_quaternion_datatype-request instead.")))

(cl:ensure-generic-function 'deg_yaw-val :lambda-list '(m))
(cl:defmethod deg_yaw-val ((m <convert_to_quaternion_datatype-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-srv:deg_yaw-val is deprecated.  Use sensor_fusion-srv:deg_yaw instead.")
  (deg_yaw m))
...
(cl:defmethod deg_pitch-val ((m <convert_to_quaternion_datatype-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-srv:deg_pitch-val is deprecated.  Use sensor_fusion-srv:deg_pitch instead.")
  (deg_pitch m))

(cl:ensure-generic-function 'deg_roll-val :lambda-list '(m))
(cl:defmethod deg_roll-val ((m <convert_to_quaternion_datatype-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-srv:deg_roll-val is deprecated.  Use sensor_fusion-srv:deg_roll instead.")
  (deg_roll m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<convert_to_quaternion_datatype-request>)))
  ...
  "sensor_fusion/convert_to_quaternion_datatypeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'convert_to_quaternion_datatype-request)))
  "Returns string type for a service object of type 'convert_to_quaternion_datatype-request"
  "sensor_fusion/convert_to_quaternion_datatypeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <convert_to_quaternion_datatype-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'convert_to_quaternion_datatype-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_fusion-srv:<convert_to_quaternion_datatype-response> is deprecated: use sensor_fusion-srv:convert_to_quaternion_datatype-response instead.")))

(cl:ensure-generic-function 'qx-val :lambda-list '(m))
(cl:defmethod qx-val ((m <convert_to_quaternion_datatype-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-srv:qx-val is deprecated.  Use sensor_fusion-srv:qx instead.")
  (qx m))

(cl:ensure-generic-function 'qy-val :lambda-list '(m))
(cl:defmethod qy-val ((m <convert_to_quaternion_datatype-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-srv:qy-val is deprecated.  Use sensor_fusion-srv:qy instead.")
  (qy m))

(cl:ensure-generic-function 'qz-val :lambda-list '(m))
(cl:defmethod qz-val ((m <convert_to_quaternion_datatype-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-srv:qz-val is deprecated.  Use sensor_fusion-srv:qz instead.")
  (qz m))

(cl:ensure-generic-function 'qw-val :lambda-list '(m))
(cl:defmethod qw-val ((m <convert_to_quaternion_datatype-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-srv:qw-val is deprecated.  Use sensor_fusion-srv:qw instead.")
  (qw m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<convert_to_quaternion_datatype-response>)))
  ...
  "sensor_fusion/convert_to_quaternion_datatypeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'convert_to_quaternion_datatype-response)))
  "Returns string type for a service object of type 'convert_to_quaternion_datatype-response"
  "sensor_fusion/convert_to_quaternion_datatypeResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'convert_to_quaternion_datatype)))
  ...
  "sensor_fusion/convert_to_quaternion_datatype")