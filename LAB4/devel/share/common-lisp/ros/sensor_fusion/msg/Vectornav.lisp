...
(cl:defmethod cl:initialize-instance :after ((m <Vectornav>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vectornav)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_fusion-msg:<Vectornav> is deprecated: use sensor_fusion-msg:Vectornav instead.")))
...
(cl:defmethod imu-val ((m <Vectornav>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:imu-val is deprecated.  Use sensor_fusion-msg:imu instead.")
  (imu m))

(cl:ensure-generic-function 'mag_field-val :lambda-list '(m))
(cl:defmethod mag_field-val ((m <Vectornav>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:mag_field-val is deprecated.  Use sensor_fusion-msg:mag_field instead.")
  (mag_field m))

(cl:ensure-generic-function 'raw_data-val :lambda-list '(m))
(cl:defmethod raw_data-val ((m <Vectornav>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_fusion-msg:raw_data-val is deprecated.  Use sensor_fusion-msg:raw_data instead.")
  (raw_data m))
